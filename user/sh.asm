...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	26858593          	addi	a1,a1,616 # 1278 <malloc+0xe8>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	08a080e7          	jalr	138(ra) # 10a4 <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	22258593          	addi	a1,a1,546 # 1280 <malloc+0xf0>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	03c080e7          	jalr	60(ra) # 10a4 <fprintf>
  exit(1);
      70:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	1f050513          	addi	a0,a0,496 # 1288 <malloc+0xf8>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	2c470713          	addi	a4,a4,708 # 1388 <malloc+0x1f8>
    ...
    panic("runcmd");
      ...
      e2:	1b250513          	addi	a0,a0,434 # 1290 <malloc+0x100>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	19858593          	addi	a1,a1,408 # 1298 <malloc+0x108>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	f9a080e7          	jalr	-102(ra) # 10a4 <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	15c58593          	addi	a1,a1,348 # 12a8 <malloc+0x118>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	f4e080e7          	jalr	-178(ra) # 10a4 <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	0d650513          	addi	a0,a0,214 # 12b8 <malloc+0x128>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	f0c080e7          	jalr	-244(ra) # 1190 <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	ec2080e7          	jalr	-318(ra) # 1190 <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	e68080e7          	jalr	-408(ra) # 1190 <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	e22080e7          	jalr	-478(ra) # 1190 <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	de0080e7          	jalr	-544(ra) # 1190 <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	fe698993          	addi	s3,s3,-26 # 13e0 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	f8298993          	addi	s3,s3,-126 # 13e0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	f1898993          	addi	s3,s3,-232 # 13e0 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	f08a8a93          	addi	s5,s5,-248 # 13d8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	eae98993          	addi	s3,s3,-338 # 13e0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	d3eb8b93          	addi	s7,s7,-706 # 12e0 <malloc+0x150>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	d0c50513          	addi	a0,a0,-756 # 12c0 <malloc+0x130>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	c4c60613          	addi	a2,a2,-948 # 12e8 <malloc+0x158>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	c3cb0b13          	addi	s6,s6,-964 # 1308 <malloc+0x178>
  ...
  return ret;
     ...
     70a:	bea50513          	addi	a0,a0,-1046 # 12f0 <malloc+0x160>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	b9050513          	addi	a0,a0,-1136 # 12f8 <malloc+0x168>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	b6e60613          	addi	a2,a2,-1170 # 1310 <malloc+0x180>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	b06a0a13          	addi	s4,s4,-1274 # 1318 <malloc+0x188>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	ad860613          	addi	a2,a2,-1320 # 1320 <malloc+0x190>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	a3a60613          	addi	a2,a2,-1478 # 12e8 <malloc+0x158>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	a5a60613          	addi	a2,a2,-1446 # 1338 <malloc+0x1a8>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	a0850513          	addi	a0,a0,-1528 # 1328 <malloc+0x198>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	a1050513          	addi	a0,a0,-1520 # 1340 <malloc+0x1b0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	a4470713          	addi	a4,a4,-1468 # 13a0 <malloc+0x210>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	95060613          	addi	a2,a2,-1712 # 1358 <malloc+0x1c8>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	92258593          	addi	a1,a1,-1758 # 1360 <malloc+0x1d0>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	65c080e7          	jalr	1628(ra) # 10a4 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	8a050513          	addi	a0,a0,-1888 # 12f0 <malloc+0x160>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	8fe48493          	addi	s1,s1,-1794 # 1370 <malloc+0x1e0>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	95848493          	addi	s1,s1,-1704 # 13f0 <buf.1130>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	94ba0a13          	addi	s4,s4,-1717 # 13f3 <buf.1130+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	8c8a8a93          	addi	s5,s5,-1848 # 1378 <malloc+0x1e8>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	57c080e7          	jalr	1404(ra) # 10a4 <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	8be50513          	addi	a0,a0,-1858 # 13f0 <buf.1130>
...
putc(int fd, char c)
{
     ...
     dfc:	ec06                	sd	ra,24(sp)
     dfe:	e822                	sd	s0,16(sp)
     e00:	1000                	addi	s0,sp,32
     e02:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     e06:	4605                	li	a2,1
     e08:	fef40593          	addi	a1,s0,-17
     e0c:	00000097          	auipc	ra,0x0
     e10:	f5e080e7          	jalr	-162(ra) # d6a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     e24:	f04a                	sd	s2,32(sp)
     e26:	ec4e                	sd	s3,24(sp)
     e28:	0080                	addi	s0,sp,64
     e2a:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
     e2c:	c299                	beqz	a3,e32 <printint+0x16>
     e2e:	0805c863          	bltz	a1,ebe <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     e32:	2581                	sext.w	a1,a1
  neg = 0;
     e34:	4881                	li	a7,0
     e36:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     e3c:	2601                	sext.w	a2,a2
     e3e:	00000517          	auipc	a0,0x0
     e42:	58250513          	addi	a0,a0,1410 # 13c0 <digits>
     e46:	883a                	mv	a6,a4
     e48:	2705                	addiw	a4,a4,1
     e4a:	02c5f7bb          	remuw	a5,a1,a2
     e4e:	1782                	slli	a5,a5,0x20
     e50:	9381                	srli	a5,a5,0x20
     e52:	97aa                	add	a5,a5,a0
     e54:	0007c783          	lbu	a5,0(a5)
     e58:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     e5c:	0005879b          	sext.w	a5,a1
     e60:	02c5d5bb          	divuw	a1,a1,a2
     e64:	0685                	addi	a3,a3,1
     e66:	fec7f0e3          	bgeu	a5,a2,e46 <printint+0x2a>
  if(neg)
     e6a:	00088b63          	beqz	a7,e80 <printint+0x64>
    buf[i++] = '-';
     e6e:	fd040793          	addi	a5,s0,-48
     e72:	973e                	add	a4,a4,a5
     e74:	02d00793          	li	a5,45
     e78:	fef70823          	sb	a5,-16(a4)
     e7c:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     e80:	02e05863          	blez	a4,eb0 <printint+0x94>
     e84:	fc040793          	addi	a5,s0,-64
     e88:	00e78933          	add	s2,a5,a4
     e8c:	fff78993          	addi	s3,a5,-1
     e90:	99ba                	add	s3,s3,a4
     e92:	377d                	addiw	a4,a4,-1
     e94:	1702                	slli	a4,a4,0x20
     e96:	9301                	srli	a4,a4,0x20
     e98:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     e9c:	fff94583          	lbu	a1,-1(s2)
     ea0:	8526                	mv	a0,s1
     ea2:	00000097          	auipc	ra,0x0
     ea6:	f58080e7          	jalr	-168(ra) # dfa <putc>
  while(--i >= 0)
     eaa:	197d                	addi	s2,s2,-1
     eac:	ff3918e3          	bne	s2,s3,e9c <printint+0x80>
}
     eb0:	70e2                	ld	ra,56(sp)
     eb2:	7442                	ld	s0,48(sp)
     eb4:	74a2                	ld	s1,40(sp)
     eb6:	7902                	ld	s2,32(sp)
     eb8:	69e2                	ld	s3,24(sp)
     eba:	6121                	addi	sp,sp,64
     ebc:	8082                	ret
    x = -xx;
     ebe:	40b005bb          	negw	a1,a1
    neg = 1;
     ec2:	4885                	li	a7,1
    x = -xx;
     ec4:	bf8d                	j	e36 <printint+0x1a>

0000000000000ec6 <vprintf>:
}
...
{
     ec6:	7119                	addi	sp,sp,-128
     ec8:	fc86                	sd	ra,120(sp)
     eca:	f8a2                	sd	s0,112(sp)
     ecc:	f4a6                	sd	s1,104(sp)
     ece:	f0ca                	sd	s2,96(sp)
     ed0:	ecce                	sd	s3,88(sp)
     ed2:	e8d2                	sd	s4,80(sp)
     ed4:	e4d6                	sd	s5,72(sp)
     ed6:	e0da                	sd	s6,64(sp)
     ed8:	fc5e                	sd	s7,56(sp)
     eda:	f862                	sd	s8,48(sp)
     edc:	f466                	sd	s9,40(sp)
     ede:	f06a                	sd	s10,32(sp)
     ee0:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     ee8:	18090f63          	beqz	s2,1086 <vprintf+0x1c0>
     eec:	8aaa                	mv	s5,a0
     eee:	8b32                	mv	s6,a2
     ef0:	00158493          	addi	s1,a1,1
  state = 0;
     ef4:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
     ...
     ef6:	02500a13          	li	s4,37
      if(c == 'd'){
     efa:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
     efe:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
     f02:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     f06:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f0a:	00000b97          	auipc	s7,0x0
     f0e:	4b6b8b93          	addi	s7,s7,1206 # 13c0 <digits>
     f12:	a839                	j	f30 <vprintf+0x6a>
        putc(fd, c);
     f14:	85ca                	mv	a1,s2
     f16:	8556                	mv	a0,s5
     f18:	00000097          	auipc	ra,0x0
     f1c:	ee2080e7          	jalr	-286(ra) # dfa <putc>
     f20:	a019                	j	f26 <vprintf+0x60>
    } else if(state == '%'){
     f22:	01498f63          	beq	s3,s4,f40 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     f26:	0485                	addi	s1,s1,1
     f28:	fff4c903          	lbu	s2,-1(s1)
     f2c:	14090d63          	beqz	s2,1086 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
     f30:	0009079b          	sext.w	a5,s2
    if(state == 0){
     f34:	fe0997e3          	bnez	s3,f22 <vprintf+0x5c>
      if(c == '%'){
     f38:	fd479ee3          	bne	a5,s4,f14 <vprintf+0x4e>
        state = '%';
     f3c:	89be                	mv	s3,a5
     f3e:	b7e5                	j	f26 <vprintf+0x60>
      if(c == 'd'){
     f40:	05878063          	beq	a5,s8,f80 <vprintf+0xba>
      } else if(c == 'l') {
     f44:	05978c63          	beq	a5,s9,f9c <vprintf+0xd6>
      } else if(c == 'x') {
     f48:	07a78863          	beq	a5,s10,fb8 <vprintf+0xf2>
      } else if(c == 'p') {
     f4c:	09b78463          	beq	a5,s11,fd4 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
     f50:	07300713          	li	a4,115
     f54:	0ce78663          	beq	a5,a4,1020 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     f58:	06300713          	li	a4,99
     f5c:	0ee78e63          	beq	a5,a4,1058 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
     f60:	11478863          	beq	a5,s4,1070 <vprintf+0x1aa>
        putc(fd, c);
      } else {
     ...
     f6c:	e92080e7          	jalr	-366(ra) # dfa <putc>
        putc(fd, c);
     f70:	85ca                	mv	a1,s2
     f72:	8556                	mv	a0,s5
     f74:	00000097          	auipc	ra,0x0
     f78:	e86080e7          	jalr	-378(ra) # dfa <putc>
      }
      state = 0;
     f7c:	4981                	li	s3,0
     f7e:	b765                	j	f26 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
     f80:	008b0913          	addi	s2,s6,8
     f84:	4685                	li	a3,1
     f86:	4629                	li	a2,10
     f88:	000b2583          	lw	a1,0(s6)
     f8c:	8556                	mv	a0,s5
     f8e:	00000097          	auipc	ra,0x0
     f92:	e8e080e7          	jalr	-370(ra) # e1c <printint>
     f96:	8b4a                	mv	s6,s2
      state = 0;
     f98:	4981                	li	s3,0
     f9a:	b771                	j	f26 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
     f9c:	008b0913          	addi	s2,s6,8
     fa0:	4681                	li	a3,0
     fa2:	4629                	li	a2,10
     fa4:	000b2583          	lw	a1,0(s6)
     fa8:	8556                	mv	a0,s5
     faa:	00000097          	auipc	ra,0x0
     fae:	e72080e7          	jalr	-398(ra) # e1c <printint>
     fb2:	8b4a                	mv	s6,s2
      state = 0;
     fb4:	4981                	li	s3,0
     fb6:	bf85                	j	f26 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
     fb8:	008b0913          	addi	s2,s6,8
     fbc:	4681                	li	a3,0
     fbe:	4641                	li	a2,16
     fc0:	000b2583          	lw	a1,0(s6)
     fc4:	8556                	mv	a0,s5
     fc6:	00000097          	auipc	ra,0x0
     fca:	e56080e7          	jalr	-426(ra) # e1c <printint>
     fce:	8b4a                	mv	s6,s2
      state = 0;
     fd0:	4981                	li	s3,0
     fd2:	bf91                	j	f26 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
     fd4:	008b0793          	addi	a5,s6,8
     fd8:	f8f43423          	sd	a5,-120(s0)
     fdc:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
     fe0:	03000593          	li	a1,48
     fe4:	8556                	mv	a0,s5
     fe6:	00000097          	auipc	ra,0x0
     fea:	e14080e7          	jalr	-492(ra) # dfa <putc>
  putc(fd, 'x');
     fee:	85ea                	mv	a1,s10
     ff0:	8556                	mv	a0,s5
     ff2:	00000097          	auipc	ra,0x0
     ff6:	e08080e7          	jalr	-504(ra) # dfa <putc>
     ffa:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    100c:	df2080e7          	jalr	-526(ra) # dfa <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1010:	0992                	slli	s3,s3,0x4
    1012:	397d                	addiw	s2,s2,-1
    1014:	fe0914e3          	bnez	s2,ffc <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    1018:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    101c:	4981                	li	s3,0
    101e:	b721                	j	f26 <vprintf+0x60>
        s = va_arg(ap, char*);
    1020:	008b0993          	addi	s3,s6,8
    1024:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    1028:	02090163          	beqz	s2,104a <vprintf+0x184>
        while(*s != 0){
    102c:	00094583          	lbu	a1,0(s2)
    1030:	c9a1                	beqz	a1,1080 <vprintf+0x1ba>
          putc(fd, *s);
    1032:	8556                	mv	a0,s5
    1034:	00000097          	auipc	ra,0x0
    1038:	dc6080e7          	jalr	-570(ra) # dfa <putc>
          s++;
    103c:	0905                	addi	s2,s2,1
        while(*s != 0){
    103e:	00094583          	lbu	a1,0(s2)
    1042:	f9e5                	bnez	a1,1032 <vprintf+0x16c>
        s = va_arg(ap, char*);
    1044:	8b4e                	mv	s6,s3
      state = 0;
    1046:	4981                	li	s3,0
    1048:	bdf9                	j	f26 <vprintf+0x60>
          s = "(null)";
    104a:	00000917          	auipc	s2,0x0
    104e:	36e90913          	addi	s2,s2,878 # 13b8 <malloc+0x228>
        while(*s != 0){
    1052:	02800593          	li	a1,40
    1056:	bff1                	j	1032 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    1058:	008b0913          	addi	s2,s6,8
    105c:	000b4583          	lbu	a1,0(s6)
    1060:	8556                	mv	a0,s5
    1062:	00000097          	auipc	ra,0x0
    1066:	d98080e7          	jalr	-616(ra) # dfa <putc>
    106a:	8b4a                	mv	s6,s2
      state = 0;
    106c:	4981                	li	s3,0
    106e:	bd65                	j	f26 <vprintf+0x60>
        putc(fd, c);
    1070:	85d2                	mv	a1,s4
    1072:	8556                	mv	a0,s5
    1074:	00000097          	auipc	ra,0x0
    1078:	d86080e7          	jalr	-634(ra) # dfa <putc>
      state = 0;
    107c:	4981                	li	s3,0
    107e:	b565                	j	f26 <vprintf+0x60>
        s = va_arg(ap, char*);
    1080:	8b4e                	mv	s6,s3
      state = 0;
    1082:	4981                	li	s3,0
    1084:	b54d                	j	f26 <vprintf+0x60>
    }
  }
}
    1086:	70e6                	ld	ra,120(sp)
    1088:	7446                	ld	s0,112(sp)
    108a:	74a6                	ld	s1,104(sp)
    108c:	7906                	ld	s2,96(sp)
    108e:	69e6                	ld	s3,88(sp)
    1090:	6a46                	ld	s4,80(sp)
    1092:	6aa6                	ld	s5,72(sp)
    1094:	6b06                	ld	s6,64(sp)
    1096:	7be2                	ld	s7,56(sp)
    1098:	7c42                	ld	s8,48(sp)
    109a:	7ca2                	ld	s9,40(sp)
    109c:	7d02                	ld	s10,32(sp)
    109e:	6de2                	ld	s11,24(sp)
    10a0:	6109                	addi	sp,sp,128
    10a2:	8082                	ret

00000000000010a4 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    10a4:	715d                	addi	sp,sp,-80
    10a6:	ec06                	sd	ra,24(sp)
    10a8:	e822                	sd	s0,16(sp)
    10aa:	1000                	addi	s0,sp,32
    10ac:	e010                	sd	a2,0(s0)
    10ae:	e414                	sd	a3,8(s0)
    10b0:	e818                	sd	a4,16(s0)
    10b2:	ec1c                	sd	a5,24(s0)
    10b4:	03043023          	sd	a6,32(s0)
    10b8:	03143423          	sd	a7,40(s0)
  va_list ap;
  ...
  vprintf(fd, fmt, ap);
    ...
    10c6:	e04080e7          	jalr	-508(ra) # ec6 <vprintf>
}
    10ca:	60e2                	ld	ra,24(sp)
    10cc:	6442                	ld	s0,16(sp)
    10ce:	6161                	addi	sp,sp,80
    10d0:	8082                	ret

00000000000010d2 <printf>:

void
printf(const char *fmt, ...)
{
    10d2:	711d                	addi	sp,sp,-96
    10d4:	ec06                	sd	ra,24(sp)
    10d6:	e822                	sd	s0,16(sp)
    10d8:	1000                	addi	s0,sp,32
    10da:	e40c                	sd	a1,8(s0)
    10dc:	e810                	sd	a2,16(s0)
    10de:	ec14                	sd	a3,24(s0)
    10e0:	f018                	sd	a4,32(s0)
    10e2:	f41c                	sd	a5,40(s0)
    10e4:	03043823          	sd	a6,48(s0)
    10e8:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    10ec:	00840613          	addi	a2,s0,8
    10f0:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    10f4:	85aa                	mv	a1,a0
    10f6:	4505                	li	a0,1
    10f8:	00000097          	auipc	ra,0x0
    10fc:	dce080e7          	jalr	-562(ra) # ec6 <vprintf>
}
    1100:	60e2                	ld	ra,24(sp)
    1102:	6442                	ld	s0,16(sp)
    1104:	6125                	addi	sp,sp,96
    1106:	8082                	ret

0000000000001108 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1116:	2d67b783          	ld	a5,726(a5) # 13e8 <freep>
    111a:	a805                	j	114a <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    111c:	4618                	lw	a4,8(a2)
    111e:	9db9                	addw	a1,a1,a4
    1120:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1124:	6398                	ld	a4,0(a5)
    1126:	6318                	ld	a4,0(a4)
    1128:	fee53823          	sd	a4,-16(a0)
    112c:	a091                	j	1170 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    112e:	ff852703          	lw	a4,-8(a0)
    1132:	9e39                	addw	a2,a2,a4
    1134:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    1136:	ff053703          	ld	a4,-16(a0)
    113a:	e398                	sd	a4,0(a5)
    113c:	a099                	j	1182 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    113e:	6398                	ld	a4,0(a5)
    1140:	00e7e463          	bltu	a5,a4,1148 <free+0x40>
    1144:	00e6ea63          	bltu	a3,a4,1158 <free+0x50>
{
    1148:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    114a:	fed7fae3          	bgeu	a5,a3,113e <free+0x36>
    114e:	6398                	ld	a4,0(a5)
    1150:	00e6e463          	bltu	a3,a4,1158 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1154:	fee7eae3          	bltu	a5,a4,1148 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    1158:	ff852583          	lw	a1,-8(a0)
    115c:	6390                	ld	a2,0(a5)
    115e:	02059713          	slli	a4,a1,0x20
    1162:	9301                	srli	a4,a4,0x20
    1164:	0712                	slli	a4,a4,0x4
    1166:	9736                	add	a4,a4,a3
    1168:	fae60ae3          	beq	a2,a4,111c <free+0x14>
    bp->s.ptr = p->s.ptr;
    116c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1170:	4790                	lw	a2,8(a5)
    1172:	02061713          	slli	a4,a2,0x20
    1176:	9301                	srli	a4,a4,0x20
    1178:	0712                	slli	a4,a4,0x4
    117a:	973e                	add	a4,a4,a5
    117c:	fae689e3          	beq	a3,a4,112e <free+0x26>
  } else
    p->s.ptr = bp;
    1180:	e394                	sd	a3,0(a5)
  freep = p;
    1182:	00000717          	auipc	a4,0x0
    1186:	26f73323          	sd	a5,614(a4) # 13e8 <freep>
}
    118a:	6422                	ld	s0,8(sp)
    118c:	0141                	addi	sp,sp,16
    118e:	8082                	ret

0000000000001190 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    11a4:	02051493          	slli	s1,a0,0x20
    11a8:	9081                	srli	s1,s1,0x20
    11aa:	04bd                	addi	s1,s1,15
    11ac:	8091                	srli	s1,s1,0x4
    11ae:	0014899b          	addiw	s3,s1,1
    11b2:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    11b4:	00000517          	auipc	a0,0x0
    11b8:	23453503          	ld	a0,564(a0) # 13e8 <freep>
    11bc:	c515                	beqz	a0,11e8 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11c2:	02977f63          	bgeu	a4,s1,1200 <malloc+0x70>
    11c6:	8a4e                	mv	s4,s3
    11c8:	0009871b          	sext.w	a4,s3
    11cc:	6685                	lui	a3,0x1
    11ce:	00d77363          	bgeu	a4,a3,11d4 <malloc+0x44>
    11d2:	6a05                	lui	s4,0x1
    11d4:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    11d8:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    11e0:	20c90913          	addi	s2,s2,524 # 13e8 <freep>
  if(p == (char*)-1)
    11e4:	5afd                	li	s5,-1
    11e6:	a88d                	j	1258 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    11e8:	00000797          	auipc	a5,0x0
    11ec:	27078793          	addi	a5,a5,624 # 1458 <base>
    11f0:	00000717          	auipc	a4,0x0
    11f4:	1ef73c23          	sd	a5,504(a4) # 13e8 <freep>
    11f8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    11fa:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    11fe:	b7e1                	j	11c6 <malloc+0x36>
      if(p->s.size == nunits)
    1200:	02e48b63          	beq	s1,a4,1236 <malloc+0xa6>
        p->s.size -= nunits;
    1204:	4137073b          	subw	a4,a4,s3
    1208:	c798                	sw	a4,8(a5)
        p += p->s.size;
    120a:	1702                	slli	a4,a4,0x20
    ...
    1212:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1216:	00000717          	auipc	a4,0x0
    121a:	1ca73923          	sd	a0,466(a4) # 13e8 <freep>
      return (void*)(p + 1);
    ...
    1232:	6121                	addi	sp,sp,64
    1234:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    1236:	6398                	ld	a4,0(a5)
    1238:	e118                	sd	a4,0(a0)
    123a:	bff1                	j	1216 <malloc+0x86>
  hp->s.size = nu;
    123c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1240:	0541                	addi	a0,a0,16
    1242:	00000097          	auipc	ra,0x0
    1246:	ec6080e7          	jalr	-314(ra) # 1108 <free>
  return freep;
    124a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    124e:	d971                	beqz	a0,1222 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1250:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1252:	4798                	lw	a4,8(a5)
    1254:	fa9776e3          	bgeu	a4,s1,1200 <malloc+0x70>
    if(p == freep)
    1258:	00093703          	ld	a4,0(s2)
    125c:	853e                	mv	a0,a5
    125e:	fef719e3          	bne	a4,a5,1250 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    1262:	8552                	mv	a0,s4
    1264:	00000097          	auipc	ra,0x0
    1268:	b6e080e7          	jalr	-1170(ra) # dd2 <sbrk>
  if(p == (char*)-1)
    126c:	fd5518e3          	bne	a0,s5,123c <malloc+0xac>
        return 0;
    1270:	4501                	li	a0,0
    1272:	bf45                	j	1222 <malloc+0x92>
